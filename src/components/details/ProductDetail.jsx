...
const ProductDetail = ({ product, fassured }) => {
  ...
  return (
    <>
      ...
      <SmallText>
        ...
        <Typography>
          <StyledBadge />
          Sign up for Shopme Pay Later and get Shopme Gift Card worth ₹100 *
          Know more{" "}
        </Typography>
        <Typography>
          <StyledBadge />
        ...
        <Typography>
          <StyledBadge />
          5% Cashback on Shopme Axis Back Card
        </Typography>
        <Typography>
          <StyledBadge />
      ...
      <Table>
        <TableBody>
          ...
          <ColumnText>
            <TableCell colSpan={2}>
              <img src={adURL} style={{ width: 390 }} alt="shopmepoints" />
            </TableCell>
          </ColumnText>
          <ColumnText>
